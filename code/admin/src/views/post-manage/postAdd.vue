<template>
    <div>
        <el-card v-loading="loading">
            ...
            <div class="bottom">
                <el-button type="primary" size="large" round @click="handleCommit">发布贴子</el-button>
                <el-button round size="large">预览贴子</el-button>
...
const commitSure = async () => {
    ...
    let res = await upLoad(`/adminApi/post/postAdd`, taleForm.value)
    if (res.data.ok) {
